...
class CreatePullRequest {
  ...
  Future<String?> _azurePullRequestUrl(
    ...
    // `az` reports the repository, not the pull request page; gg_merge
    // assembles the page — the same one `gg do publish` prints while it
    // waits for the merge.
    final pullRequest = _firstEntry(result.stdout.toString());
    return pullRequest == null
        ? null
        : gg_merge.azurePullRequestWebUrl(pullRequest);
  }
